...
*
* Parameters:  x1  - x coordinate of upper-left point
...
* Returned:    0 on success; otherwise, -1
******************************************************************************/
int SDLManager::drawRectangle(int x1, int y1, int x2, int y2)
{
	return rectangleRGBA(mpcRenderer, x1, y1, x2, y2,
		mcForegroundColor.getR(), mcForegroundColor.getG(),
		mcForegroundColor.getB(), mcForegroundColor.getA());
}
...
int SDLManager::drawRectangle(int x1, int y1, int x2, int y2,
	Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	return rectangleRGBA(mpcRenderer, x1, y1, x2, y2, r, g, b, a);
}

int SDLManager::drawRectangle(int x1, int y1, int x2, int y2,
	const Color &rcColor)
{
	return rectangleRGBA(mpcRenderer, x1, y1, x2, y2, rcColor.getR(),
		rcColor.getG(), rcColor.getB(), rcColor.getA());
}
...
*
* Description: Draw a colored rounded box
*
* Parameters:  x1  - x coordinate of upper-left point
*							 y1  - y coordinate of upper-left point
*							 x2  - x coordinate of lower-right point
...
* Returned:    0 on success; otherwise, -1
******************************************************************************/
int SDLManager::drawRoundedBox(int x1, int y1, int x2, int y2, int radius)
{
	return roundedBoxRGBA(mpcRenderer, x1, y1, x2, y2, radius,
		mcForegroundColor.getR(), mcForegroundColor.getG(),
		mcForegroundColor.getB(), mcForegroundColor.getA());
}
...
int SDLManager::drawRoundedBox(int x1, int y1, int x2, int y2, int radius,
	Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	return roundedBoxRGBA(mpcRenderer, x1, y1, x2, y2, radius, r, g, b, a);
}

int SDLManager::drawRoundedBox(int x1, int y1, int x2, int y2, int radius,
	const Color &rcColor)
{
	return roundedBoxRGBA(mpcRenderer, x1, y1, x2, y2, radius, rcColor.getR(),
		rcColor.getG(), rcColor.getB(), rcColor.getA());
}
...
void SDLManager::mousePosition(int &xMouseCoord, int &yMouseCoord)
{
...
void SDLManager::rotateSprite (SDLSprite &rcSDLSprite, double degrees)
{
