...
class SDLManager
{
  ...
  //****************************************************************************
	...
	int drawRectangle(int x1, int y1, int x2, int y2,
		Uint8 r, Uint8 g, Uint8 b, Uint8 a);
	int drawRectangle(int x1, int y1, int x2, int y2, const Color &rcColor);

	int drawRoundedBox(int x1, int y1, int x2, int y2, int radius);
	int drawRoundedBox(int x1, int y1, int x2, int y2, int radius,
		Uint8 r, Uint8 g, Uint8 b, Uint8 a);
	int drawRoundedBox(int x1, int y1, int x2, int y2, int radius,
		const Color &rcColor);
  ...
  // Input Routines
  //****************************************************************************
  void mousePosition(int &xMouseCoord, int &yMouseCoord);
